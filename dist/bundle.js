...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsEvent = __webpack_require__(157);

	var _viewsEvent2 = _interopRequireDefault(_viewsEvent);

	_react2["default"].render(_react2["default"].createElement(_viewsEvent2["default"], null), document.getElementById("entry"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Event = (function (_React$Component) {
		...
		function Event() {
			...
			_qwest2["default"].get("https://whispering-sea-1365.herokuapp.com/hello").then(function (xhr, resp) {
				console.log(resp);
			});

			// let a = ({
			// 	url: "https://whispering-sea-1365.herokuapp.com/hello",
		...
		_createClass(Event, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement("img", { src: "http://placehold.it/400x300", alt: "a placeholder image" })
				);
			}
		}]);
